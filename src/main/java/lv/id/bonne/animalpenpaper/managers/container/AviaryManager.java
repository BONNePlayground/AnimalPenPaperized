...
public class AviaryManager extends AbstractContainerManager
{
...
// ---------------------------------------------------------------------
    ...
    public static final AviaryManager INSTANCE = new AviaryManager();


    private AviaryManager() {}
...
// ---------------------------------------------------------------------
    ...
    {
        return BIRD_CATCHER_FILLED_MODEL;
    }
    ...
    {
        return AnimalPenPlugin.configuration().getAviaryAnimalSize();
    }
    ...
    {
        return AnimalPenPlugin.configuration().isGrowAviaryAnimals();
    }
...
// ---------------------------------------------------------------------
    ...
    {
        return this.createStructureItem("animal_pen:aviary_iron");
    }
...
// ---------------------------------------------------------------------
    ...
    public static final NamespacedKey AVIARY_KEY =
        new NamespacedKey("animal_pen", "aviary_data");

    public static final NamespacedKey BIRD_CATCHER_PICKABLE =
        new NamespacedKey("animal_pen", "bird_catcher_pickable");

    public static final String BIRD_CATCHER_MODEL = "animal_pen:bird_catcher";

    private static final String BIRD_CATCHER_FILLED_MODEL = "animal_pen:bird_catcher_filled";

    public static final String AVIARY_MODEL = "animal_pen:aviary";
}