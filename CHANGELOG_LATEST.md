## Animal Pens Paperized 1.5.0

- Fixed a bug where players could not dye sheep if were holding just one dye
- Fixed a bug where players could constantly dye a sheep with same color.
